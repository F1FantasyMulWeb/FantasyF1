...
import 's096_informacion_grupo_model.dart';
export 's096_informacion_grupo_model.dart';

class S096InformacionGrupoWidget extends StatefulWidget {
  const S096InformacionGrupoWidget({
    Key? key,
    String? rutaPagina,
  ...
  @override
  _S096InformacionGrupoWidgetState createState() =>
      _S096InformacionGrupoWidgetState();
}

class _S096InformacionGrupoWidgetState
    extends State<S096InformacionGrupoWidget> {
  late S096InformacionGrupoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S096InformacionGrupoModel());
