...
import 's051_campeonatos_model.dart';
export 's051_campeonatos_model.dart';

class S051CampeonatosWidget extends StatefulWidget {
  const S051CampeonatosWidget({
    Key? key,
    String? rutaPagina,
  ...
  @override
  _S051CampeonatosWidgetState createState() => _S051CampeonatosWidgetState();
}

class _S051CampeonatosWidgetState extends State<S051CampeonatosWidget> {
  late S051CampeonatosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S051CampeonatosModel());
