...
class _S54PantallaCrearGrupoWidgetState
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(0.0, 25.0, 0.0, 50.0),
                        child: Container(
                          width: 400.0,
                          height: 90.0,
                          decoration: const BoxDecoration(
  ...
  Future<void> mandarDatosGrupo() async {
    ...
    await clienteController.sendDataGrupo(
        _model.textFieldCodigoAccesoGrupoController.text, _model.textFieldContrasenaGrupoController.text, idGrupo);
