        ...
        child: Scaffold(
            appBar: CustomAppBar(
                ...
                leading: AppbarImage(
                    ...
                    margin:
                        EdgeInsets.only(left: 28.h, top: 12.v, bottom: 11.v),
                    onTap: () {
                          ...
                          Padding(
                              ...
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return ClasificacionroItemWidget(
                                        onTapClasificacionro: () {
                                      onTapClasificacionro(context);
                                    });
                                  })),
                          Padding(
                              padding: EdgeInsets.only(
                                  left: 30.h, top: 55.v, right: 30.h),
                              child: Row(
