...
class Client {
  ...
  Future<void> DataAlbon() async {
    ...
    http.Response response = await http.get(
        Uri.parse('http://ergast.com/api/f1/2023/drivers/max_verstappen.json'));
  ...
  Future<void> DataBahrein() async {
    ...
    mapa["lat"] = pilotos2[5]
        .split(":")[1]
        .substring(0, pilotos2[5].split(":")[1].indexOf(","));
    mapa["long"] = pilotos2[5]
        .split(":")[2]
        .substring(0, pilotos2[5].split(":")[2].indexOf(","));
    mapa["locality"] = pilotos2[5]
        .split(":")[3]
        .substring(0, pilotos2[5].split(":")[3].indexOf(","));
    mapa["country"] = pilotos2[5]
        .split(":")[4]
        .substring(0, pilotos2[5].split(":")[4].indexOf("}"));
  ...
  Future<Map<String, String>> DataRedBull() async {
    // Perform the asynchronous operation (API call, network request, etc.)
    http.Response response = await http.get(
        Uri.parse('http://ergast.com/api/f1/2023/constructors/red_bull.json'));
    ...
    mapa["nationality"] = pilotos3[3]
        .split(":")[1]
        .substring(0, pilotos3[3].split(":")[1].indexOf("}"));
