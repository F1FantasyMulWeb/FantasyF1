...
class F1FantasyV2SupabaseUser extends BaseAuthUser {
  F1FantasyV2SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> f1FantasyV2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = F1FantasyV2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
